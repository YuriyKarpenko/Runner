...
namespace Runner.ViewModels
{
    class VmRunItem : VmBase
    {
        ...
        public System.Collections.ObjectModel.ObservableCollection<VmRunParameter> Parameters { get; private set; }
        public string RunPath { get; set; }

        public VmRunItem(OptionItem optionItem)
        {
        ...
        {
            Parameters = new System.Collections.ObjectModel.ObservableCollection<VmRunParameter>(
                _optionItem.Parameters
                .Select(i => new VmRunParameter(_optionItem, i))
                .ToArray()
                );
